...
class ModelExtensionModuleIssBulksyncImport extends Model {
    ...
    private function productAdd($item) {
        $this->load->model('extension/module/iss_bulksync/product');
        return $this->model_extension_module_iss_bulksync_product->addProduct($item);
    }

    private function productUpdate($item) {
        $this->load->model('extension/module/iss_bulksync/product');
        return $this->model_extension_module_iss_bulksync_product->liteEditProduct($item['product_id'], $item);
    }
