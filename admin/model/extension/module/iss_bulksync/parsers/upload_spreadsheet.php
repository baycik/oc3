...
$parser_name = 'Excel Table import'; //Label to show to user

class ModelExtensionModuleIssBulksyncParsersUploadSpreadsheet extends ModelExtensionModuleIssBulksyncParse {

    public function install() {
        $this->load->model('setting/setting');

        $ext = $this->config->get('config_file_ext_allowed');
        if (strpos($ext, 'xlsx') === false) {
        ...
        if (strpos($mime, 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet') === false) {
